...
const MovieHero = () => {
    return (
        ...
        <div className="relative hidden lg:block" style={{height: "30rem"}}>
            ...
            style={{backgroundImage: "linear-gradient(90deg, rgb(34, 34, 34) 24.97%, rgb(34, 34, 34) 38.3%, rgb(34, 34, 34, 0.64) 97.47%, rgb(34, 34, 34) 100%)" }}
            ></div>

            <div className="absolute z-30 w-64 h-96 left-64 top-11">
                <img 
